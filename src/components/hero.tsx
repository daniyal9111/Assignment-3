    ...
    <>
      <section className="w-[1920px] h-[829px] ml-[1px] py-[140px] px-[220px] bg-[#043873] flex items-center text-white">
        <div className="w-[656px] h-[361px] gap-10 flex flex-col">
          ...
          <div>
            <button className=" hover:bg-white hover:text-[#043873]
             w-[219px] h-[63px] rounded-lg p-5 bg-[#4F9CF9] gap-[10px] text-[18px] font-medium leading-[23px] tracking-[-2%]">
              Try Whitepace free
            </button>
          </div>
        </div>
      ...
      <section className="w-[1920px] h-[829px] ml-[1px] py-[140px] px-[220px] bg-white flex items-center text-black">
        <div className="w-[672px] h-[411px] gap-10 flex flex-col justify-between">
          ...
          <div className="w-[201px] h-[63px] rounded-md py-5 px-10 bg-[#4F9CF9]  flex items-center justify-centergap-[10px] gap-[10px]  hover:bg-blue-500 ">
            <button className=" text-[18px] font-medium leading-[23px] tracking-[-2%]">
            Get Started
            </button>
          </div>
        </div>
      ...
      <section className="w-[1920px] h-[829px] flex items-center justify-center bg-white ">
        ...
        <div className="flex-1 w-[670px] h-[661px] flex flex-col items-start justify-center gap-6">
          ...
          <div className="w-[186px] h-[63px] rounded-md py-5 px-10 bg-[#4F9CF9] ">
      ...
      <section className="w-[1920px] h-[829px] ml-[1px] py-[140px] px-[220px] bg-[#043873] flex items-center gap-10 text-white">
        <div className="w-[656px] h-[361px] gap-10 flex flex-col">
          ...
          <div>
            <button className="w-[219px] h-[63px] rounded-lg p-5 bg-[#4F9CF9] gap-[10px] text-[18px] font-medium leading-[23px] tracking-[-2%]">
            Let’s Go
            </button>
          </div>
        </div>
