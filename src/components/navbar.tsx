 ...
 <nav className="w-[1920px] h-[92px] bg-[#043873] flex items-center justify-between px-[220px] py-4 text-white ">
  ...
  <div className="flex items-center justify-center ">
    <ul className="w-[549px] flex items-center gap-[32px]">
      <li className=" hover:bg-white hover:text-[#043873] hover:rounded-lg p-3">Products</li>
      <li className=" hover:bg-white hover:text-[#043873] hover:rounded-lg p-3">Solution</li>
      <li className=" hover:bg-white hover:text-[#043873] hover:rounded-lg p-3">Resources</li>
      <li className=" hover:bg-white hover:text-[#043873] hover:rounded-lg p-3">Pricing</li>
    </ul>
